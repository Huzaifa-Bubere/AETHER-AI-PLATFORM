...
import { Users, Video, TrendingUp, AlertTriangle, Activity, Award, ClipboardList, Plus } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <Card>
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-xl">Aptitude Module</h3>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <Link
              to="/admin/aptitude"
              className="rounded-lg border border-border bg-secondary/50 p-4 text-center hover:bg-secondary transition-colors"
            >
            ...
            <Link
              to="/admin/aptitude/tests"
              className="rounded-lg border border-border bg-secondary/50 p-4 text-center hover:bg-secondary transition-colors"
            >
              <p className="text-sm font-medium">Tests</p>
            </Link>
            <Link
              to="/admin/aptitude/students"
              className="rounded-lg border border-border bg-secondary/50 p-4 text-center hover:bg-secondary transition-colors"
            >
